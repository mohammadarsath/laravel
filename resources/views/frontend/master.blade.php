...
<html lang="en">
  ...
  <head>
    ...
    <title>ARS Villa Agency - Real Estate HTML5 Template</title>
...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-8">
          <ul class="info">
            <li><i class="fa fa-envelope"></i> am.arsath89@gmail.com</li>
            <li><i class="fa fa-map"></i> Sri lanka Western</li>
          </ul>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <nav class="main-nav">
                    <!-- ***** Logo Start ***** -->
                    <a href="C:\Users\USER\myproject\public\the_best_choice_for_family-removebg-preview.png" class="logo">
                        <h1>Villa</h1>
                    </a>
                    <!-- ***** Logo End ***** -->
                    <!-- ***** Menu Start ***** -->
    ...
    <div class="owl-carousel owl-banner">
      <div class="item item-1">
        <div class="header-text">
          <span class="category">Colombo, <em>Sri lanka</em></span>
          <h2>Hurry!<br>Get the Best Villa for you</h2>
        </div>
      </div>
      <div class="item item-2">
        <div class="header-text">
          <span class="category">Melbourne, <em>Western</em></span>
          <h2>Be Quick!<br>Get the best villa in town</h2>
        </div>
      </div>
      <div class="item item-3">
        <div class="header-text">
          <span class="category">Dubai, <em>Dubai</em></span>
                ...
                <div class="tab-pane fade show active" id="appartment" role="tabpanel" aria-labelledby="appartment-tab">
                  <div class="row">
                    ...
                    <div class="col-lg-3">
                      ...
                      <p>Welcome to ARS Villa Agency – Your Dream Home Awaits! 
                      <br><br>At ARS Villa Agency, we specialize in offering luxurious and budget-friendly villas in prime locations. Whether you're looking for a serene getaway, an investment property, or a forever home, we bring you the best options with transparent deals and hassle-free services.</p>
  ...
  <div class="contact-content">
    <div class="container">
      <div class="row">
        <div class="col-lg-7">
          <div id="map">
            <iframe src="https://www.google.com/maps/place/%E0%AE%95%E0%AF%8A%E0%AE%B4%E0%AF%81%E0%AE%AE%E0%AF%8D%E0%AE%AA%E0%AF%81+10,+%E0%AE%95%E0%AF%8A%E0%AE%B4%E0%AF%81%E0%AE%AE%E0%AF%8D%E0%AE%AA%E0%AF%81/@6.9301823,79.8418667,13.96z/data=!4m6!3m5!1s0x3ae259097a27717b:0xe8f74aefc50b71d7!8m2!3d6.9224091!4d79.8660836!16s%2Fg%2F11_r3r6ln?entry=ttu&g_ep=EgoyMDI1MDMwNC4wIKXMDSoJLDEwMjExNDUzSAFQAw%3D%3D" width="100%" height="500px" frameborder="0" style="border:0; border-radius: 10px; box-shadow: 0px 0px 15px rgba(0, 0, 0, 0.15);" allowfullscreen=""></iframe>
          </div>
          <div class="row">
            <div class="col-lg-6">
              <div class="item phone">
                <img src="assets/images/phone-icon.png" alt="" style="max-width: 52px;">
                <h6>0759484843<br><span>Phone Number</span></h6>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="item email">
                <img src="assets/images/email-icon.png" alt="" style="max-width: 52px;">
                <h6>am.arsath89@gmail.com<br><span>Business Email</span></h6>
              </div>
            </div>
          </div>
        </div>
  ...
  <footer>
    <div class="container">
      <div class="col-lg-8">
        <p>Copyright © 2048 ARS Villa Agency Co., Ltd. All rights reserved. 
